...
public interface StockRepo extends JpaRepository<Stock,Integer> {
    ...
    Long getAllAvailableOnlyStockForProductByBatch(@Param("batchCode") String batchCode);

    @Query(name = "Stock.getAllAvailableOnlyStockForProductByProductId")
    Long getAllAvailableOnlyStockForProductByProductId(@Param("productId") Integer productId);
